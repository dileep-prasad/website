...
<head>
    ...
    <title>Dileep Prasad - ICT Teacher & Tech Enthusiast</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css">
    <style>
        /* --- CSS Variables (New Color Scheme) --- */
        :root {
            --bg-main-dark: #181a1e; /* Even darker background for the page */
            --bg-content-dark: #222222; /* Background for hero/section containers */
            --bg-card-dark: #2a2f3a; /* Background for cards/elements within sections */
            --text-light: #e0e0e0;
            --text-muted: #b0b0b0;
            --accent-green: #66cc33;
            --accent-green-darker: #52a329;
            --border-dark: #444954;
            --progressbar-track: #404552;
        ...
        * {
        ...
        .hero-header {
            ...
            display: flex; /* For centering wrapper content vertically if needed */
            flex-direction: column;
            justify-content: center; /* Centers content if hero-header is taller than content */
        }
        ...
        .btn.active { /* This class for primary action button */
    ...
    <div class="hero-header">
        <div class="wrapper">
            ...
            <div class="container">
                ...
                <div class="hero-text">
                    <h5>Hi I'm <span class="input"></span></h5> <h1>Dileep Prasad</h1>
